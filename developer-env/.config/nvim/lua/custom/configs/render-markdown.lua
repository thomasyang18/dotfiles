local opts = {
	...
	-- I may want to change this to get more osbidian like..... I think I like the default though it seems the most obsidian like https://github.com/MeanderingProgrammer/render-markdown.nvim/wiki 
	render_modes = true, -- yeahh obsidian like 
